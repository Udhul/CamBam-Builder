...
- For direct-core `SpiralMill_CW`/`SpiralMill_CCW`, let `H` be `hole_diameter`,
  ...
  enforces this when both diameters resolve explicitly; an Auto hole diameter remains
  CamBam-resolved from circle targets. This exact relationship is user-validated

...
This is **four accepted milestones and two remaining milestones**, not a time or
effort percentage. M3's bounded geometry and native-output gate is accepted;
M4 composition and M5 controller output remain open.

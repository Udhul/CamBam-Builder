...
def create_server(service: DocumentService) -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "server workspace. document_export and document_inspect are read-only calls and "
            "omit request_id. Select CAM operations by machining intent: Profile offsets "

...
def create_server(service: DocumentService) -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "centerline without cutter-radius compensation (choose Vcutter explicitly when "
            "appropriate), and Drill uses point or circle "
            ...
            "stock offset/surface are independent of its dimensions, and Grid/IsoGrid repeats "
            "the whole Part's MOPs. Imported Manual/PointList placement data is preserved but "
            "is not authored by that tool. Use Automatic Profile holding tabs when retention "
            "is required; manual tab points are not exposed. A Part with no MOPs has nothing "

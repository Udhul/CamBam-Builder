...
def create_server(service: DocumentService) -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "centerline without cutter-radius compensation (VCutter is the exact native enum "
            "token but does not turn Engrave into width/depth-varying V-carving), and Drill uses point or circle "
            ...
            "the whole Part's MOPs over shared source geometry. Imported valid Manual/PointList placement data is preserved but "

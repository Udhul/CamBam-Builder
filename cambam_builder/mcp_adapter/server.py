...
def create_server(service: DocumentService) -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "inside/outside a boundary, Pocket clears its interior, Engrave follows a "
            "centerline without cutter-radius compensation, and Drill uses point or circle "
            ...
            "nesting with machining_configure_part: Grid/IsoGrid repeats the whole Part's MOPs; "
            "a Part with no MOPs has nothing to nest. Do not clone geometry when the user asks for part-level nesting. Layer display "

...
def create_server(service: DocumentService) -> Server:
    ...
    server = Server(
        ...
        instructions=(
            ...
            "inside/outside a closed boundary or to a vertex-order-relative side of an open "
            "Pline, Pocket clears a closed interior, Engrave follows a curve or Text "
            "centerline without cutter-radius compensation (EndMill and VCutter are supported "
            "tool-shape selections, but neither fills Text interiors or turns Engrave into "
            "width/depth-varying V-carving), and Drill uses point or circle "
            ...
            "the whole Part's MOPs over shared source geometry. Nesting does not enlarge Part "
            "stock, so verify that every nested outermost toolpath fits the configured stock. "

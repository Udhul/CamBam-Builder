...
from .core import CamBamEntity, Primitive, BoundingBox, VertexInput
from .cad import Layer, Pline, Circle, Rect, Arc, Points, Text
from .cam import (
...
class CamBamProject:
    ...
    def copy_primitive_tree(self, root: Identifiable, target_project: "CamBamProject", *,
        ...
        from .transfer import copy_primitive_tree
    ...
    def transfer_primitive_tree(self, root: Identifiable, target_project: "CamBamProject", *,
        ...
        from .transfer import transfer_primitive_tree
...
# , transform_to_bake: Optional[np.ndarray] = None
    ...
    def save(self, file_path: str, pretty_print: bool = True):
        ...
        Same as export()"""
        from .writer import save_cambam_file
